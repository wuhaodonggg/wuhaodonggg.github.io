...
$(document).ready(function(e){
    $('.copyright').html('©2022 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By hodong”s Blog！');
})
...
function show_date_time(){
    $('.framework-info').html('Blog已经安全运行<span id="span_dt_dt" style="color: #fff;"></span>');
